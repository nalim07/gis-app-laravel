...
<body class="m-0 md:overflow-hidden">
    <div class="flex h-screen flex-col items-center justify-center md:flex-row">
        ...
        <div
            ...
            <!-- Elment Background bawah -->
            <div
                class="absolute md:-bottom-48 md:-left-72 md:h-[400px] lg:-bottom-64 lg:-left-48 lg:h-[500px] xl:-bottom-72 xl:-left-48 xl:h-[600px]">
                <div class="absolute left-[81px] top-[26px] h-[557px] w-[557px] rounded-full border border-[#cafcfb]">
                </div>
                <div class="absolute left-0 top-0 h-[557px] w-[557px] rounded-full border border-[#cafcfb]"></div>
            </div>
        </div>
        ...
        <div class="flex w-full flex-row items-center justify-center md:w-1/2 lg:w-2/5">
            <div
                class="flex w-full flex-col items-center justify-center md:mx-4 md:rounded-lg md:py-4 md:shadow-md xl:mx-12">
                ...
                <form action="#" method="" class="flexflex-col w-full px-8 md:px-12">
                    <div class="mt-6 flex flex-col gap-1">
                        <!-- field name -->
                        <label for="name"
                            class="font-inter text-sm font-normal leading-tight text-slate-700">Name</label>
                        <div
                            class="inline-flex items-center justify-start gap-2 self-stretch rounded-lg border border-gray-300 px-4 py-3">
                        ...
                        <!-- Email -->
                        <label for="email"
                            class="mt-4 font-inter text-sm font-normal leading-tight text-slate-700">Email</label>
                        <div
                            class="inline-flex items-center justify-start gap-2 self-stretch rounded-lg border border-gray-300 px-4 py-3">
                            <div class="relative h-6 w-6 pr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <!-- Phone Number -->
                        <label for="Phone"
                            class="mt-4 font-inter text-sm font-normal leading-tight text-slate-700">Phone
                            Number</label>
                        <div
                            class="inline-flex items-center justify-start gap-2 self-stretch rounded-lg border border-gray-300 px-4 py-3">
                            <div class="relative h-6 w-6 pr-2">
                            ...
                            <input type="number" id="Phone" name="Phone" placeholder="Input Phone Number"
                                class="w-full bg-transparent font-inter text-base font-medium leading-normal text-slate-500 outline-none placeholder:font-inter placeholder:text-base placeholder:text-slate-500"
                                required />
                        </div>
                        ...
                        <div
                            ...
                            <div class="h-6 w-6 cursor-pointer"
                                onclick="togglePassword('password', 'eye-open1', 'eye-closed1')">
                                <svg id="eye-open1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <svg id="eye-closed1" xmlns="http://www.w3.org/2000/svg"
                                    class="h-6 w-6 text-slate-500" viewBox="0 0 24 24" fill="none">
                        ...
                        <span id="confirm-password-error" class="mt-2 hidden text-sm text-red-500">
